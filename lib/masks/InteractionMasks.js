...
export default function InteractionMasks({ columns, rows, rowHeight, eventBus, enableCellAutoFocus, enableCellCopyPaste, enableCellDragAndDrop, editorPortalTarget, cellNavigationMode, gridRef, totalHeaderHeight, scrollLeft, scrollTop, onSelectedCellChange, onCheckCellIsEditable, onRowsUpdate, scrollToCell, getCellValue = (r, c) => r[c.key] }) {
    ...
    useEffect(() => {
        ...
        const handleDragEnter = (overRowIdx) => {
            setDraggedPosition(Object.assign(Object.assign({}, draggedPosition), { overRowIdx }));
        };
    ...
    function selectCell(position, enableEditor = false) {
        ...
        if (enableEditor && isCellEditable(position)) {
            setSelectedPosition(Object.assign(Object.assign({}, position), { status: 'EDIT', key: null }));
        }
        else {
            setSelectedPosition(Object.assign(Object.assign({}, position), { status: 'SELECT' }));
        }
    ...
    function handleDragStart(e) {
        ...
        setDraggedPosition(Object.assign(Object.assign({}, selectedPosition), { overRowIdx: selectedPosition.rowIdx }));
    }
    ...
    return (React.createElement("div", { onKeyDown: onKeyDown },
        ...
        selectedPosition.status === 'EDIT' && isCellWithinBounds(selectedPosition) && (React.createElement(EditorPortal, { target: editorPortalTarget },
            React.createElement(EditorContainer, Object.assign({ firstEditorKeyPress: selectedPosition.key, onCommit: onCommit, onCommitCancel: closeEditor, rowIdx: selectedPosition.rowIdx, row: rows[selectedPosition.rowIdx], rowHeight: rowHeight, column: columns[selectedPosition.idx], scrollLeft: scrollLeft, scrollTop: scrollTop, getCellValue: getCellValue }, getEditorPosition()))))));
}
